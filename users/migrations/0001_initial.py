# Generated by Django 5.2.7 on 2025-10-15 21:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('USD', 'US Dollar'), ('EUR', 'Euro'), ('RUB', 'Russian Ruble'), ('BYN', 'Belarusian Ruble'), ('KZT', 'Kazakhstani Tenge'), ('UAH', 'Ukrainian Hryvnia'), ('CNY', 'Chinese Yuan'), ('JPY', 'Japanese Yen')], default='USD', max_length=3, verbose_name='Currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('MANAGER', 'Manager'), ('SUPPORT', 'Support')], default='SUPPORT', max_length=20, verbose_name='Employee Role')),
